...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/personal')); ?>" class="list-group-item list-group-item-action">
                Personal web (Bleach)
            </a>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/example-app/resources/views/routing.blade.php ENDPATH**/ ?>